...
if (isset($_GET['id']) && $_GET['id'] != ""){
    ...
    $sql1   = "SELECT * FROM mycourses WHERE id = '$id'";
...
if (isset($_POST['simpan'])){
    ...
    if (empty($error)){
        if ($id != ""){
            $sql1   = "UPDATE mycourses SET judul = '$judul', kutipan = '$kutipan', isi = '$isi', tgl_isi = NOW() WHERE id = '$id'";
        } else {
            $sql1   = "INSERT INTO mycourses (judul, kutipan, isi, tgl_isi) VALUES ('$judul', '$kutipan', '$isi', NOW())";
        }
        $q1     = mysqli_query ($koneksi, $sql1);
...
<h1>Input My Courses</h1>
<div class="mb-3 row">
    <a href="mycourses.php"><< Back to My Courses</a>
</div>
<?php
if ($error){
    ?>
