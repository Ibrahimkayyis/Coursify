...
?>
<h1>Admin partners Page</h1>
<p>
    <a href="input_partners.php">
    ...
    <tbody>
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td><img src="../gambar/<?php echo partners_foto($r1['id']) ?>" style = "max-height:100px; max-width:100px" alt=""></td>
                <td><?php echo htmlspecialchars($r1['nama']) ?></td>
                <td>
                    <a href="input_partners.php?id=<?php echo $r1['id'] ?>">
                        <span class="badge text-bg-warning">Edit</span>
                    </a>
                    
                    <a href="partners.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Are You Sure Want to Delete Data ?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for ($i = 1; $i <= $pages; $i++) {
            ?>
            <li class="page-item">
                <a class="page-link" href="partners.php?katakunci=<?php echo urlencode($katakunci) ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
