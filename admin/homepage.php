...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1 = "DELETE FROM homepage WHERE id = '$id'";
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1 = "SELECT * FROM homepage $sqltambahan";
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="homepage.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Are You Sure Want to Delete Data ?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for ($i = 1; $i <= $pages; $i++) {
            ?>
            <li class="page-item">
                <a class="page-link" href="homepage.php?katakunci=<?php echo urlencode($katakunci) ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
